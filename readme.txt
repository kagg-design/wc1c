...
* Исправлена ошибка, при которой любые нотисы и предупреждения в других плагинах приводили к аварийному завершению импорта.
* Исправлена ошибка с использованием update_woocommerce_term_meta(), которая объявлена устаревшей, начиная с WooCommerce 3.6.
* Исправлена ошибка с генерацией нотиса в admin.php.
